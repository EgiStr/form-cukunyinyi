    ...
    <footer className="bg-green-900 text-white py-6">
      <div className="container mx-auto flex flex-col md:flex-row justify-between px-4">
        <div className="mb-4">
          ...
          <img className='w-72 md:w-96 rounded mt-5' src={iteramengabdi}/>
        </div>
        <div>
        ...
        <div className="w-full md:w-4/12">
          ...
          <p className="mt-2">
            <a href="mailto:ekowisatamangrovecukunyinyi@gmail.com" className="hover:text-green-500">mangrovecukunyiny@gmail.com</a>
          </p>
          <p className="mt-2">
