      ...
      try {
        ...
        let response = {
          data: {
            data: {
              id: 1,
              email: "john.doe@contoh.com",
              date: "2024-11-02",
              purpose: "Liburan",
              touristType: "Internasional",
              touristGroupType: "Keluarga",
              touristCount: 4,
              paymentType: "Kartu Kredit",
              paymentProof: "https://contoh.com/bukti_pembayaran.jpg",
              userInformation: "John Doe, No Paspor: A12345678",
              totalPrice: 500,
            },
          },
        };
